...
@implementation GuruFxTileableEffect (Timing)
...
// This is how much the clip is retimed.  1.0 is 100%.  2.0 is 200%
-(CMTime) retimingRatio
{
	...
	return CMTimeMultiplyByRatio(frameDuration, (int)numerator, (int)denominator);
}
...
{
	CMTime time = kCMTimeInvalid;
	[self.apiManager.timingAPIv4 startTimeOfInputToFilter:&time];
	return time;
}
