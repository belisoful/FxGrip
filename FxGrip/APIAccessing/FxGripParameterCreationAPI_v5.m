...
- (BOOL)preprocess:(NSMutableDictionary*)userInfo
{
	...
	[self.effect.notifier postNotificationName:FxGripNotifyAPI_ParameterSetNamePreName object:self.effect userInfo:userInfo];
	
	[self.effect.notifier postNotificationName:FxGripNotifyAPI_ParameterAddPreName object:self.effect userInfo:userInfo];
				...
				parameterFlags:(FxParameterFlags)flags
{
	...
	[self.effect.notifier postNotificationName:FxGripNotifyAPI_ParameterAddName object:self.effect userInfo:concreteUserInfo];
	[self.effect.notifier postNotificationName:FxGripNotifyAPI_ParameterStartGroupName object:self.effect userInfo:concreteUserInfo];
...
- (BOOL)endParameterSubGroup
{
	...
	if (success && _subGroupStack.count > 1) {
		...
		[self.effect.notifier postNotificationName:FxGripNotifyAPI_ParameterEndGroupName object:self.effect userInfo:userInfo];
	}
	return success;
}
