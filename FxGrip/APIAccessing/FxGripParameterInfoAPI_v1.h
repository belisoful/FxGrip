...
/*!
	@protocol   FxParameterInfoAPI_v1
	@abstract   Read-only queries about a plug-in's parameters, in the style of Apple's FxPlug APIs.
	@discussion Introduced in FxGrip 1.0. FxGrip's own API. Reports parameter existence, type,
...
*/
@protocol FxParameterInfoAPI_v1 <NSObject>
...
/*!
	...
	@abstract   FxGrip's implementation of FxParameterInfoAPI_v1.
	@discussion Introduced in FxGrip 1.0. Wraps Apple's FxDynamicParameterAPI_v3 for the roster
				walk. Vended by FxGripAPIAccessing's parameterInfoAPIv1. Previously these queries
				lived on the fabricated FxDynamicParameterAPI_v4.
*/
@interface FxGripParameterInfoAPI_v1 : FxGripCommonAPI <FxParameterInfoAPI_v1>
