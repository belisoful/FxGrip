...
- (NSError*)removeParameter:(UInt32)parameterID
{
	...
	if (!error) {
		...
		[self.effect.notifier postNotificationName:FxGripNotifyAPI_ParameterRemoveName object:self.effect userInfo:userInfo reverse:YES];
	}
				 ...
				 name:(NSString**)parameterName
{
	...
	if(!error && *parameterName != nil) {
		...
		[self.effect.notifier postNotificationName:FxGripNotifyAPI_ParameterGetNameName object:self.effect userInfo:userInfo];
					...
					name:(NSString*)newName
{
	...
	[self.effect.notifier postNotificationName:FxGripNotifyAPI_ParameterSetNamePreName object:nObject userInfo:userInfo];
	...
	if (error) {
		...
		[self.effect.notifier postNotificationName:FxGripNotifyAPI_ParameterSetNameName object:nObject userInfo:userInfo.copy];
	}
	return error;
}
		   ...
		   sliderMaximum:(double)sliderMax
{
	...
	if(!error) {
		...
		[self.effect.notifier postNotificationName:FxGripNotifyAPI_ParameterSetFloatBoundsName object:self.effect userInfo:userInfo];
	}
	return error;
}
		   ...
		   sliderMaximum:(int)sliderMax
{
	...
	if(!error) {
		...
		[self.effect.notifier postNotificationName:FxGripNotifyAPI_ParameterSetIntBoundsName object:self.effect userInfo:userInfo];
	}
	return error;
}
					 ...
					 defaultValue:(UInt32)defaultIndex
{
	...
	[self.effect.notifier postNotificationName:FxGripNotifyAPI_ParameterSetMenuPreName object:nObject userInfo:userInfo];
	...
	if (error) {
		...
		[self.effect.notifier postNotificationName:FxGripNotifyAPI_ParameterSetMenuName object:nObject userInfo:userInfo.copy];
	}
	return error;
}
