...
- (BOOL)setBoolValue:(BOOL)value toParameter:(UInt32)parameterID atTime:(CMTime)time
{
	...
	if (success) {
		...
		[self.effect.notifier postNotificationName:FxNotifyAPI_ParameterSetBoolName object:self.effect userInfo:userInfo];
	}
...
- (BOOL)setCustomParameterValue:(nonnull NSObject<NSSecureCoding,NSCopying> *)value toParameter:(UInt32)parameterID atTime:(CMTime)time
{
	...
	if (success) {
		...
		[self.effect.notifier postNotificationName:FxNotifyAPI_ParameterSetCustomValueName object:self.effect userInfo:userInfo];
	}
...
- (BOOL)setFloatValue:(double)value toParameter:(UInt32)parameterID atTime:(CMTime)time
{
	...
	if (success) {
		...
		[self.effect.notifier postNotificationName:FxNotifyAPI_ParameterSetFloatName object:self.effect userInfo:userInfo];
	}
...
- (BOOL)setHistogramBlackIn:(double)blackIn blackOut:(double)blackOut whiteIn:(double)whiteIn whiteOut:(double)whiteOut gamma:(double)gamma forChannel:(FxHistogramChannel)channel fromParameter:(UInt32)parameterID atTime:(CMTime)time
{
	...
	if (success) {
		...
		[self.effect.notifier postNotificationName:FxNotifyAPI_ParameterSetHistogramName object:self.effect userInfo:userInfo];
	}
...
- (BOOL)setIntValue:(int)value toParameter:(UInt32)parameterID atTime:(CMTime)time
{
	...
	if (success) {
		...
		[self.effect.notifier postNotificationName:FxNotifyAPI_ParameterSetIntName object:self.effect userInfo:userInfo];
	}
...
- (BOOL)setParameterFlags:(FxParameterFlags)flags toParameter:(UInt32)parameterID
{
	...
	[self.effect.notifier postNotificationName:FxNotifyAPI_ParameterSetFlagsPreName object:self.effect userInfo:userInfo];
	...
	if (success) {
		...
		[self.effect.notifier postNotificationName:FxNotifyAPI_ParameterSetFlagsName object:self.effect userInfo:userInfo.copy];
	}
...
- (BOOL)setPathID:(nonnull FxPathID)pathID toParameter:(UInt32)parameterID atTime:(CMTime)time
{
	...
	if (success) {
		...
		[self.effect.notifier postNotificationName:FxNotifyAPI_ParameterSetPathIDName object:self.effect userInfo:userInfo];
	}
...
- (BOOL)setRedValue:(double)red greenValue:(double)green blueValue:(double)blue alphaValue:(double)alpha toParameter:(UInt32)parameterID atTime:(CMTime)time
{
	...
	if (success) {
		...
		[self.effect.notifier postNotificationName:FxNotifyAPI_ParameterSetRGBAName object:self.effect userInfo:userInfo];
	}
...
- (BOOL)setRedValue:(double)red greenValue:(double)green blueValue:(double)blue toParameter:(UInt32)parameterID atTime:(CMTime)time
{
	...
	if (success) {
		...
		[self.effect.notifier postNotificationName:FxNotifyAPI_ParameterSetRGBName object:self.effect userInfo:userInfo];
	}
...
- (BOOL)setStringParameterValue:(nonnull NSString *)string toParameter:(UInt32)parameterID
{
	...
	[self.effect.notifier postNotificationName:FxNotifyAPI_ParameterSetStringValuePreName object:self.effect userInfo:userInfo];
	userInfo.parameterID = parameterID;
	userInfo.mutableFxParameter.parameterID = parameterID;
	...
	if (success) {
		[self.effect.notifier postNotificationName:FxNotifyAPI_ParameterSetStringValueName object:self.effect userInfo:userInfo.copy];
	}
...
- (BOOL)setXValue:(double)x YValue:(double)y toParameter:(UInt32)parameterID atTime:(CMTime)time
{
	...
	if (success) {
		...
		[self.effect.notifier postNotificationName:FxNotifyAPI_ParameterSetXYName object:self.effect userInfo:userInfo];
	}
