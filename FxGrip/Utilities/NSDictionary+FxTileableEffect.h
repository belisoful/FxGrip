//
//  NSDictionary+FxTileableEffect.h
//  XPC Service
//
//  Created by ~ ~ on 3/19/24.
//

#ifndef NSDictionary_FxTileableEffect_h
...
@interface NSNumber (FxTileableEffect)

- (FxParameterType)parameterType;

@end

@interface NSString (FxTileableEffect)
...
@interface NSArray (FxTileableEffect)
...
@interface NSDictionary (FxTileableEffect)
...
@interface NSMutableDictionary (FxTileableEffect)
...
#endif	//	NSDictionary_FxTileableEffect_h
