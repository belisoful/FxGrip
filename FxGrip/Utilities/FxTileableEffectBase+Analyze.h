//
//  FxTileableEffectBase+Analyze.h
//  FxGrip
//
//  Copyright © 2026 Belisoful All rights reserved.
//

#ifndef FxTileableEffectBase_Analyze_h
#define FxTileableEffectBase_Analyze_h
...
/*!
	@category   FxTileableEffectBase (Analyze)
	...
	@discussion Introduced in FxGrip 1.0. This category implements the FxPlug `FxAnalyzer`
				...
				backward variant.
*/
@interface FxTileableEffectBase (Analyze)
