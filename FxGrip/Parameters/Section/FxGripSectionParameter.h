...
/*!
	...
	@discussion Introduced in FxGrip 1.0. A read-only header row that spans the inspector
				...
				alignment, font, weight, width, point size, color with opacity, and the
...
/*!
	...
	@discussion Introduced in FxGrip 1.0. The value is an FxGripSectionData carrying the
				...
				transform, alignment, font name, weight, width, and margin keys declared in
				FxGripSection.h. When the configuration omits the title, the parameter name
